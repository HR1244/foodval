...
export async function POST(req) {
  try {
    ...
    try {
      ...
      // Generate a dynamic image based on the product name using a free AI image generator
      productData.image = `https://image.pollinations.ai/prompt/${encodeURIComponent(productData.name + " food product packaging")}?width=400&height=400&nologo=true`; 
